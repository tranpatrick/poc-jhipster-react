package fr.ptran.halitran.repository;

import fr.ptran.halitran.HalitranApp;

import fr.ptran.halitran.config.Constants;
import fr.ptran.halitran.config.audit.AuditEventConverter;
import fr.ptran.halitran.domain.PersistentAuditEvent;
...
import static fr.ptran.halitran.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
